...
const Login = () => {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(circle at 50% 50%, #3f32aa 0%, #1a154c 100%)",
      }}
    >
      <style>{`
        @keyframes float-1 {
        ...
        @keyframes float-3 {
          ...
          50% { transform: translateY(-30px) translateX(25px); opacity: 0.65; }
        }
        @keyframes float-4 {
          0%, 100% { transform: translateY(0px) translateX(0px); opacity: 0.15; }
      ...
      {/* Soft Radial Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-500/15 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-purple-500/10 rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-indigo-600/10 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div
        className="absolute rounded-full bg-indigo-200/50 shadow-[0_0_8px_rgba(255,255,255,0.8)] pointer-events-none blur-[0.5px]"
        style={{
          top: "20%",
          left: "15%",
          width: "6px",
      ...
      <div className="z-10 bg-white shadow-xl rounded-2xl p-8 w-full max-w-sm mx-4">
        <h2 className="text-2xl font-extrabold text-gray-950 mb-6">Login</h2>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center text-sm text-gray-600">
              <input
                type="checkbox"
                className="mr-2 rounded-lg text-indigo-600 focus:ring-indigo-500"
              />
              Remember me
            </label>
      ...
      {/* Ownership */}
      <p className="z-10 text-xs text-slate-400 mt-4 text-center">
